...
reset=()=>{
  ...
  window.location="/registermaid";
            ...
            reset=()=>{
                  this.props.history.push('/MaidRegistration');
            }
                               ...
                               {/*} <Card className="mx-3"> </Card> #FFF8D5*/}
                                    ...
                                    <Form onSubmit={this.register} noValidate>
                                      ...
                                      <div style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                                        ...
                                        <Input type="text" name="m_name" placeholder="Full Name" onChange={this.handleChange } noValidate required />
                                      ...
                                      {errors.aadhar_card.length > 0 && <span className='error'>{errors.contact_no}</span>}
                                      </InputGroup>
                                      </div>
